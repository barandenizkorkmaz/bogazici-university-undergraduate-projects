...
public class Queen extends Piece{
	...
	*/
	...
	public void drawYourself(Graphics g, int positionX, int positionY, int squareWidth) {
		...
		g.drawLine(positionX+(int)(squareWidth*2.0/4.0), positionY+(int)(squareWidth*2.0/4.0), positionX+(int)(squareWidth*2.0/4.0), positionY+(int)(squareWidth*0.2/4.0));
		...
		int[] yPoints={positionY+(int)(squareWidth*1.0/4.0),positionY+(int)(squareWidth*1.0/4.0),positionY+(int)(squareWidth*3.0/4.0)};
